        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.editText2),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("emilyb@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.editText3),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("emily blunt"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.editText6),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("movie actress"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.editText),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("I'm a dreamer and a thinker"), closeSoftKeyboard());
